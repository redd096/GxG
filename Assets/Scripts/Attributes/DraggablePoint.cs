...
/// <summary>
/// drag vector3 or array of vector3
/// </summary>
public class DraggablePointAttribute : Attribute { }
...
public class DraggablePointDrawer : Editor
{
    ...
    void Vector3Handle(SerializedProperty property)
    {
        ...
        if (draggablePoints.Length > 0)
        {
            ...
            //make this vector3 a position handle
    ...
    void Vector3InArrayHandle(SerializedProperty property, SerializedProperty parent, int index)
    {
        ...
        //get draggable points
        object[] draggablePoints = parentfield.GetCustomAttributes(typeof(DraggablePointAttribute), false);
        if (draggablePoints.Length > 0)
        {
            //show parent name + [index]
            Handles.Label(property.vector3Value, parent.name + "[" + index + "]");
